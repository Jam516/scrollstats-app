...
const predefinedColors = ['#264653', '#DDD1C7', '#2A9D8F', '#EF6461', '#E9C46A', '#896A67', '#F4A261', '#823038', '#E76F51', '#1E000E', '#A982ED', '#D1345B', '#3454D1', '#90C2E7', '#9C9990'];
...
const StackedBarChart: React.FC<StackedBarChartProps> = ({ data }) => {
    ...
    const projectColors = projects.reduce((acc, project, index) => {
        acc[project] = predefinedColors[index % predefinedColors.length];
        return acc;
